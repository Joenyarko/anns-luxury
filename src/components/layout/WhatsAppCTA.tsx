...
const WhatsAppCTA = () => {
  return (
    <div className="fixed bottom-6 right-4 md:bottom-10 md:right-10 z-[100] animate-fade-in flex items-center justify-center">
      ...
      <div className="absolute w-24 h-24 md:w-28 md:h-28 bg-[#25D366]/20 rounded-full animate-ping" />
      
      <Button
        variant="default"
        size="icon"
        asChild
        className="w-20 h-20 md:w-24 md:h-24 rounded-full bg-[#25D366] hover:bg-[#20ba59] shadow-[0_15px_45px_rgba(37,211,102,0.5)] md:shadow-[0_20px_60px_rgba(37,211,102,0.6)] hover:shadow-[0_25px_70px_rgba(37,211,102,0.8)] text-white border-none transform hover:scale-110 active:scale-95 transition-all duration-300 group z-10"
      >
        <a 
        ...
        >
          <svg 
            viewBox="0 0 24 24" 
            className="w-14 h-14 md:w-20 md:h-20 fill-white drop-shadow-md"
