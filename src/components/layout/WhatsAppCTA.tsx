  ...
  return (
    <div className="fixed bottom-6 right-4 md:bottom-10 md:right-10 z-[100] animate-fade-in flex items-center justify-center">
      ...
      <Button
        ...
        size="icon"
        asChild
        className="w-16 h-16 md:w-20 md:h-20 rounded-full bg-[#25D366] hover:bg-[#20ba59] shadow-xl hover:shadow-2xl text-white border-none transform hover:scale-105 active:scale-95 transition-all duration-300 group z-10"
      >
        <a 
          ...
          className="flex items-center justify-center w-full h-full p-3 md:p-4"
        >
          <svg 
            viewBox="0 0 448 512" 
            className="w-full h-full fill-white drop-shadow-lg"
